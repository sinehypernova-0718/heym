...
| Inputs | 1 |
| Outputs | 1 |
| Output | `$nodeLabel.status`, `$nodeLabel.message`, `$nodeLabel.username`, `$nodeLabel.avatar_url` |
...
- Pair it with [Discord Trigger](./discord-trigger-node.md) for interactive Discord workflows
