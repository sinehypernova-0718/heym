...
| `driveConvertTargetFormat` | string (enum) | Target format: `pdf`, `docx`, `html`, `md`, `txt`, `jpg`, `png`, `bmp`, `webp` (`convertFile` only) |
...
- **Documents (via pandoc):** `docx`, `html`, `md`, `txt`, `csv` → `pdf`, `docx`, `html`, `md`, `txt`; `pdf` (input) → `docx`, `md`, `txt`, `html`
